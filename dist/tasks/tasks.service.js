...
let TasksService = class TasksService {
    ...
    async create(createTaskDto, id) {
        return this.taskModel.create(Object.assign(Object.assign({}, createTaskDto), { userId: id }));
    }
    async delete(id) {
    ...
    async completedTask(id) {
        ...
        return await this.taskModel.findByIdAndUpdate({ _id: id }, { completed: !task.completed }, { new: true });
    }
};
__decorate([
    (0, common_1.Inject)(users_service_1.UsersService),
    __metadata("design:type", users_service_1.UsersService)
], TasksService.prototype, "usersService", void 0);
